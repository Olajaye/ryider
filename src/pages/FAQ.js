  ...
  return (
    <main>
      ...
      <div className='container mx-auto px-4 flex flex-col space-y-7 py-7'>
        ...
        <div>
          <h1>What are the account types on the platform?</h1>
          <div>
        ...
        <div>
          <h1>How do I activate a Publisher account?</h1>
          <p>
        ...
        <div>
          <h1>How can I earn money as a Publisher?</h1>
          <div>
        ...
        <div>
         <h1>What benefits do Shoppers enjoy?</h1>
        ...
        <div>
        <h1>Can I switch between account types?</h1>
        ...
        <div>
        <h1>What makes Ryider unique?</h1>
        ...
        <div>
        <h1>What is CrowdAid, and how does it work?</h1>
        ...
        <div>
        <h1>Can I promote my business on your platform?</h1>
        ...
        <div>
        <h1>What makes Ryider different from other platforms?</h1>
        ...
        <div>
        <h1>How do I start using the platform?</h1>
