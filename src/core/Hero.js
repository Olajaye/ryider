...
const Hero = () => {
  return (
    <main className='container mx-auto px-4 pt-7'>
      <div className='md:h-[400px] lg:h-[600px] w-full bg-heroBg bg-no-repeat bg-cover flex justify-center items-center rounded-lg p-4'>
        <div className='flex items-center flex-col text-center font-poppins'>
          ...
          <h6 className='md:max-w-[55%] mt-5 text-white'>Turn your online activities into real earnings. Complete tasks, get paid, and make the most of your time!"</h6>
